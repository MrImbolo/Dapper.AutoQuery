...
namespace Dapper.AutoQuery.ExtensionsBenchmark
{
    ...
    public class SelectBenchmark
    {
        ...
        {
            return (await _db.QueryAsync<Product>("SELECT * FROM Products WHERE Id IN @Ids", 
                new { Ids = new[] { 36, 37, 38 } })).ToList();
        }

        [Benchmark]
        public async Task<List<Product>> DapperExtensions_SelectAsyncWithWhereArgs()
        {
        ...
        [Benchmark]
        public async Task<List<Product>> DapperExtensions_SelectAsyncWithLambda()
        {
